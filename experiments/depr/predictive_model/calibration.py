...
class Calibrator:
    ...
    def run_extended_calibration(self):
        ...
        # Partial coalescing latencies at multiple offsets -> do a linear fit
        ...
        # Example shape occupancy factor
    ...
    def _measure_issue_cycles(self) -> float:
        ...
        instructions_per_loop = 2  # Adjust based on actual instructions per iteration
        cpti = cycles_est / (loops * instructions_per_loop)
        measure_issue_cycles = cpti  # No need to multiply by warp_size
